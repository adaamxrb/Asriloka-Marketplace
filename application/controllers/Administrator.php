...
class Administrator extends CI_Controller
{
    ...
    function tambah_kategori_produk_sub()
    {
        ...
        if (isset($_POST['submit'])) {
            $data = array(
                'id_kategori_produk' => $this->input->post('b'),
    ...
    function tambah_rekening()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            $this->template->load('administrator/template', 'administrator/additional/mod_rekening/view_rekening_tambah', $data);
        }
    }
    ...
    function proses_penjualan()
    {
        ...
        foreach ($order->result_array() as $row) {
            ...
            if ($cek_produk->num_rows() >= 1) {
                ...
                $data = array(
                    'id_produk_perusahaan' => $p['id_produk'],
    ...
    function bayar_bonus()
    {
        ...
        if (isset($_POST['submit'])) {
            $data = array(
                'id_reseller' => $this->input->post('idk'),
